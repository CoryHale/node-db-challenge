...
- [X] Explain the difference between `Relational Databases` and `SQL`.
      ...
      A `Relational Database` is the setup for your tables and gives you the information you need so that they can interact with one another.
      `SQL` otherwise known as Search Query Language, is the HOW you can interact with your Relational Databases to get the information you need when you need it.

- [X] Why do tables need a `primary key`?

      Because thats is the piece of info that the tables need to interact with one another.
